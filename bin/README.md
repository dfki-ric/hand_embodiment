...
python bin/vis_segment_markers_to_robot.py shadow flip --mocap-config examples/config/markers/20211112_april.yaml --mano-config examples/config/mano/20211105_april.yaml --demo-file raw_data/passport_flip/20211112_r_WK37_passport_set0.json --passport --show-mano --segment 0
