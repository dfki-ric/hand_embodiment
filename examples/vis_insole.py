...
def main():
    ...
    mesh2origin = pt.concat(pt.invert_transform(insole.insole_mesh2insole_markers), insole.insole_markers2origin)
    fig.plot_transform(mesh2origin, s=0.15)
    fig.plot_transform(insole.insole_mesh2insole_markers, s=0.1)
